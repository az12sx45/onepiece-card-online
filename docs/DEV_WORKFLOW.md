...
## 航海選單與攻擊特效（2026-09-21，發布中）

右上操作收合成三橫線選單；命中圖集由約 200–250ms 延長至单擊 700ms、連擊每下 420ms，切磋長連擊等完整演出後關閉。修改 Board 兩個 HTML、三支 JS 與五支 QA，更新四份專案文件。隔離 npm start 18923，選單32、快速航行20、FX Chrome116及雙頁LAN通過；切磋／部署結果見 [完整紀錄](BOARD_MENU_PACING_20260921.md)。
