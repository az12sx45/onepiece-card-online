...
const BASELINE = '2d0e40572a925869af5d78031578c4b03b7589e4';
...
const GENERATOR = 'board-stall-completion-release-v1';
const NEW_PROGRAMS = [];
const BATTLE_PROGRAMS = ['board_battle.html', 'js/board_battle.js', 'js/board_character_depth.js'];
...
if (require.main === module) {
  try { formal.main(); } catch (error) { console.error(`BOARD_STALL_COMPLETION_RELEASE=FAIL ${error.message}`); process.exitCode = 1; }
}
