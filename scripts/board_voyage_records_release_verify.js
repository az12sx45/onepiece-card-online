...
const OUTPUT = process.env.BOARD_QA_OUTPUT || "D:/Codex_QA/board-voyage-records-20260914/release";
...
async function main(){
  ...
  if(mode === "r2"){
    const baseline = JSON.parse(execFileSync("git", ["show", "3ac13b7bfd3324a86b7d7186d9985d7cfbd5b58f:public/desktop/catalog-v3.json"], { cwd:ROOT, encoding:"utf8", windowsHide:true }));
    const old = JSON.parse(execFileSync("git", ["show", `3ac13b7bfd3324a86b7d7186d9985d7cfbd5b58f:public/${baseline.games.board.manifestPath}`], { cwd:ROOT, encoding:"utf8", maxBuffer:16*1024*1024, windowsHide:true }));
