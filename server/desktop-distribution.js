...
const LAUNCHER_EVENTS = new Set([
  ...
  'LAUNCHER_DECORATION_PLACEMENT_SET', 'LAUNCHER_ROOM_SET', 'LAUNCHER_CARD_SET', 'LAUNCHER_COMMENTS_GET', 'LAUNCHER_COMMENT_POST', 'LAUNCHER_COMMENT_DELETE',
  'LAUNCHER_CHARACTER_GET', 'LAUNCHER_CHARACTER_INTERACT', 'LAUNCHER_CHARACTER_WORK_START', 'LAUNCHER_CHARACTER_WORK_CLAIM',
